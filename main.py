...
# --- 1. Мини-сервер Flask для Render (исправленный запуск порта) ---
app = Flask('')
...
ADMIN_ID = 7847949636             # Твой реальный Telegram ID администратора
...
# Продукты для покупки через Stars
PRODUKTIB = {
    'сухой': {
        'title': 'Сушка',
        'цена': 49,
...
# --- 9. Анкетирование для персональных программ ---
